...
const skills = [
  ...
  "GraphQL", "REST APIs", "Git", "Figma", "UI/UX Design"
]
              ...
              <CardContent className="space-y-6 p-0">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    My journey in tech began five years ago, and I've been crafting digital experiences ever since.
                  </p>
                </div>
                ...
                <div>
                  <p className="text-muted-foreground">
                    ...
                    That's why I focus on creating intuitive, accessible, and beautiful digital products 
                    that solve real problems and bring joy to users. My approach combines technical expertise 
                    with design thinking to build solutions that are not just functional but delightful to use.
                  </p>
                </div>
                ...
                <div>
                  <p className="text-muted-foreground">
                    ...
                    new recipes in the kitchen, or diving into a good book. These diverse interests help 
                    me bring a well-rounded perspective to my work and fuel my creativity.
                  </p>
                </div>
              </CardContent>
            </Card>
